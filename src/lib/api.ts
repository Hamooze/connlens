...
function makeDevSnapshot(): ConnLensSnapshot {
  ...
  return {
    ...
    connections: [
      ...
      row("vercel", "vercel", "Vercel", "Vercel (...9c22)", "vercel.com", "team_acme", "active", false, now),
      row("neon", "neon", "Neon DB", "Neon (...d011)", "console.neon.tech", "us-east-1", "active", false, now),
